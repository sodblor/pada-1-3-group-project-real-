  ...
  return (
    <Content style={{ margin: "24px" }}>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Аялагчдын сэтгэгдлүүд</h2>
        
        <div className="relative">
          <div className="flex space-x-6 pb-6 -mx-4 px-4 overflow-x-auto scrollbar-hide">
            {[
              // Reviews for Hentii
              {
                id: 1,
                ...
                rating: 5,
                comment: 'Хэнтий аймгийн Хэрлэн хотод амьдардаг. Эндхийн байгаль, уул ус нь үнэхээр гайхалтай. Ялангуяа Балданбэрэвээ хийд харахад гайхалтай газар.',
                date: '2023-10-20',
              ...
              },
              {
                ...
                location: 'Дархан',
                rating: 4,
                comment: 'Хэнтийд зун амралтаараа ирсэн. Хүйтэн уул, цэлмэг голууд нь үнэхээр гоё байлаа. Дараа дахин ирэх дуртай.',
                date: '2023-08-15',
              ...
              },
              {
                ...
                location: 'Хэнтий',
                rating: 5,
                comment: 'Хэнтий миний төрсөн нутаг. Эндхийн хүмүүс эелдэг, хайрладаг. Ялангуяа намар цагт ногоон байх үед нь ирвэл хамгийн сайхан.',
                date: '2023-09-30',
                avatar: 'https://randomuser.me/api/portraits/men/28.jpg',
                aimag: 'Хэнтий'
              },
              // Add more aimag-specific reviews here
              {
                id: 4,
                author: 'Алтанцэцэг Б.',
                location: 'Улаанбаатар',
                rating: 5,
                comment: 'Хэнтий аймгийн байгаль гайхалтай. Аялал маань үнэхээр үнэ цэнэтэй байлаа.',
                date: '2023-10-15',
                avatar: 'https://randomuser.me/api/portraits/women/44.jpg',
                aimag: 'Хэнтий'
              }
            ].filter(review => review.aimag === name).map((review) => (
              <div 
                key={review.id} 
                className="flex-shrink-0 w-80 bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-md transition-shadow"
              >
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="ml-2 text-sm text-gray-500">
                    {new Date(review.date).toLocaleDateString('mn-MN', { year: 'numeric', month: 'long', day: 'numeric' })}
                  </span>
                </div>
